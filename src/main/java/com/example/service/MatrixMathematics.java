...
public class MatrixMathematics {
	 ...
	 * A matrix that has an inverse is called non-singular or invertible.
	 * If the matrix does not have an inverse, it is called singular.
	 * For a singular matrix, the values of the inverted matrix are either NAN or Infinity.
	 * Only square matrices have an inverse, and the following method will throw an exception if the matrix is not square.
	 *
	 * @param matrix
	 * @return
	 * @throws NoSquareException
